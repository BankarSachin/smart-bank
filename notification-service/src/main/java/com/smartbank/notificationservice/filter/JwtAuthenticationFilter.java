package com.smartbank.notificationservice.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter{
	...
	*/
	 ...
	 * @throws IOException
	 */
	private void handleError(HttpServletRequest request,HttpServletResponse response,NotificationException txnException) throws IOException {
