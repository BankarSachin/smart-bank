package com.smartbank.notificationservice.exception.handler;
...
import com.smartbank.notificationservice.factory.ResponseEntityFactory;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		ExceptionCode exceptionCode = ExceptionCode.NTFS_INVALID_INPUT;
	...
	public ResponseEntity<Object> handleTxnException(NotificationException ex, WebRequest request) {
		final String requestCorelationId = request.getHeader(SysConstant.SYS_REQ_CORR_ID_HEADER);
	...
	public ResponseEntity<Object> handleBadCredentialsException(BadCredentialsException ex, WebRequest request) {
		...
		ExceptionCode exceptionCode = ExceptionCode.NTFS_BAD_CREDENTIALS;
	...
	public ResponseEntity<Object> handleAll(Throwable ex, WebRequest request) {
		...
		ExceptionCode exceptionCode = ExceptionCode.NTFS_UNKNOWN_EXCEPTION;
